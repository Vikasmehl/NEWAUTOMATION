    ...
    it('Add to cart', function ()
{
    ...
    cy.xpath('//*[@id="customer_menu_top"]').click()
    cy.xpath('//*[@id="loginFrm_loginname"]').type('Rajat795')
    cy.xpath('//*[@id="loginFrm_password"]').type('Rajat@11')
    cy.xpath('//*[@id="loginFrm"]/fieldset/button').click()
    ...
    cy.get('li').should('contain','Account Dashboard')
    cy.get('h1').should('contain','My Account').and('contain','Rajat')
    ...
    cy.get('div').should('contain','Men')
    cy.xpath('//*[@id="maincontainer"]/div/div/div/div/ul/li[1]/div/a').click()
    cy.xpath('//*[@id="maincontainer"]/div/div/div/div/div[2]/div[3]/div[2]/a/img').click()

    cy.get('h1').should('contain','Dove Men +Care Body Wash')
    cy.xpath('//*[@id="product_quantity"]').clear()
    cy.xpath('//*[@id="product_quantity"]').type('4')
...
cy.visit('https://automationteststore.com/')
cy.xpath('//*[@id="customer_menu_top"]').click()
cy.xpath('//*[@id="loginFrm_loginname"]').type('nirmalsingh')
cy.xpath('//*[@id="loginFrm_password"]').type('Gurnoor123')
cy.xpath('//*[@id="loginFrm"]/fieldset/button').click()
...
cy.get('li').should('contain','Account Dashboard')
cy.get('h1').should('contain','My Account').and('contain','nirmal')


//Add product in cart

cy.xpath('//*[@id="categorymenu"]/nav/ul/li[3]/a').click()

cy.get('div').should('contain','Makeup')
cy.xpath('//*[@id="maincontainer"]/div/div/div/div/div[3]/div[7]/div[2]/a/img').click()


cy.get('h1').should('contain','Viva Glam Lipstick')
cy.xpath('//*[@id="product_quantity"]').clear()
cy.xpath('//*[@id="product_quantity"]').type('4')
